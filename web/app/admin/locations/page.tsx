...
type AdminPin = {
  ...
  photoIds: string[]
  photos: { _id: string; title: string; src: string; width: number; height: number; blurDataURL: string | null }[]
}
...
const EMPTY_FORM: PinForm = { name: '', description: '', lat: '', lng: '', photoIds: [] }
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-10">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <h2 style={{ fontFamily: "'Italiana', serif" }} className="text-3xl text-sky-400 tracking-wider">
            Locations
          </h2>
      ...
      {/* Map */}
      <div className="rounded-xl overflow-hidden border border-slate-800 mb-6" style={{ height: 400 }}>
        {!loading && (
                ...
                return (
                  <button
                    ...
                    className={`relative aspect-square rounded overflow-hidden border-2 transition-all ${
                      selected ? 'border-sky-400' : 'border-transparent opacity-50 hover:opacity-80'
                    }`}
                  >
                    <Image
